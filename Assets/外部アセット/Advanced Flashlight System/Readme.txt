...
Thank you for chosing the Advanced Flashlight System for Unity! We hope it adds a new level of realism to your game development projects.

Update Version:
1.0:
* Package Release.
1.1:
* Added The Abilty To Use Infinity FlashLight Battery Life.
* Added The Abilty To Use Unity New Input System.

#Note:
if an error appear in line 12 at FlashManager Script... You have to install Unity New Input System Package.
This instruction will guide you:
 * Go to:
