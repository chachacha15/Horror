	...
	public class WaveSpectrumGPU : MonoBehaviour
	{
        ...
        void OnDestroy()
		{
            if (!Application.isPlaying)
            {
                ...
                DestroyImmediate(m_map2);
                DestroyImmediate(m_map3);
                DestroyImmediate(m_map4);
                DestroyImmediate(m_variance);
