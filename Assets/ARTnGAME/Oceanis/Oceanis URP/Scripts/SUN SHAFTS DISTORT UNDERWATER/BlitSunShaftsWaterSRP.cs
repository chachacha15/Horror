...
{
    public class BlitSunShaftsWaterSRP : UnityEngine.Rendering.Universal.ScriptableRendererFeature
    {
        [System.Serializable]
        ...
        BlitPassSunShaftsWaterSRP blitPass;
        ...
        public override void Create()
        {
            ...
            blitPass = new BlitPassSunShaftsWaterSRP(settings.Event, settings.blitMaterial, settings.blitMaterialPassIndex, name, settings);
            //m_RenderTextureHandle.Init(settings.textureId);//v0.1
